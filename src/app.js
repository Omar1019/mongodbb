...
import path from "path"; //nos pide rutas absolutas(c:user\usuario\documents) y las configura para que funcionen en distintos Sistemas operativos
...
const exphbs = create({
  ...
  helpers:{
    pesoad:function(pesosadolar){
      return pesosadolar*19.79;
    },
    pesoeu: function(pesoeud){
      return pesoeud*22.04;
    },
  }
});
